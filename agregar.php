...
<body class="hidden">
    ...
    <main>
        ...
        <section class="seccion">
            ...
            <div class="bloque">
                <form id="formulario" action="config/agregar.php" method="post" enctype="multipart/form-data">
            
                    <label for="input-titulo">Tetlautilistli (menor de 20 caracteres):<span>*</span></label> <br>
                    <input name="titulo" type="textarea" id="input-titulo" placeholder="Introduccion" required> <br>

                    <label for="input-contenido">Ikipaliotlok:<span>*</span></label> <br>
                    <textarea name="texto" rows="10" cols="50" placeholder="Escriba algo aqui" id="input-contenido" required></textarea> 
                    <br><br>

                    <label for="input-imagen">Ixiptli (opcional)</label>
                    <input type="file" name="imagen" id="input-imagen">
                    <br><br>

                    <label for="btnEnviar">Iualis </label><br>
                    <input type="submit" id="btnEnviar"><br><br>
